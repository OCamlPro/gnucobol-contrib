      ...
      *>
      *>  DB2TEST7.cob is free software: you can redistribute it and/or 
      *>  modify it under the terms of the GNU Lesser General Public License as 
      *>  published by the Free Software Foundation, either version 3 of the
      *>  License, or (at your option) any later version.
      *>
      *>  DB2TEST7.cob is distributed in the hope that it will be useful, 
      *>  but WITHOUT ANY WARRANTY; without even the implied warranty of 
      *>  MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.
      *>  See the GNU Lesser General Public License for more details.
      *>
      *>  You should have received a copy of the GNU Lesser General Public  
      *>  License along with DB2TEST7.cob.
      *>  If not, see <http://www.gnu.org/licenses/>.
      *>************************************************************************
      
      *>************************************************************************
      *> Program:      DB2TEST7.cob
      *>
      ...
      *>     this deletes the screen       
       ...
       01 MAIN-FUNCTION-SCREEN.
          ...
          05 FILLER LINE 10 COLUMN 5
             ...
             FOREGROUND-COLOR COB-COLOR-GREEN.
          05 FILLER LINE 11 COLUMN 5
             VALUE "F8 - List   (select first, next, previous, last)"
             FOREGROUND-COLOR COB-COLOR-GREEN.
      ...
      *>------------------------------------------------------------------------
          ...
          CALL "DB2MOD7" USING LN-MOD END-CALL
      ...
      *>------------------------------------------------------------------------
          ...
          INITIALIZE WS-OUT-BOOK-TABLE
      
          PERFORM FOREVER
             DISPLAY HEADER-SCREEN END-DISPLAY  
             DISPLAY LIST-BOOK-SCREEN END-DISPLAY
             ...
             PERFORM VARYING WS-IND-1 FROM 1 BY 1
               ...
               OR    WS-IND-1 > WS-OUT-BOOK-TAB-LINE-NR
                ...
                MOVE WS-OUT-BOOK-TAB-ISBN(WS-IND-1)
                  TO SC-ISBN
                DISPLAY LIST-BOOK-LINE END-DISPLAY
             END-PERFORM
             
             DISPLAY MESSAGE-SCREEN END-DISPLAY 
             ACCEPT LIST-BOOK-SCREEN END-ACCEPT
      ...
      *>  copy table data from linkage
          MOVE LN-OUT-BOOK-TABLE       OF LN-OUTPUT
            TO WS-OUT-BOOK-TABLE          
