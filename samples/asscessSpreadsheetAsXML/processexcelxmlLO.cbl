      ...
      *           with debugging mode
       ...
       01 table-column-literal value '<table:table-column' pic x(19).
       01 text-p-literal       value '<text:p>' pic x(08).
       01 end-row-literal      value '</table:table-row>' pic x(18).
       01 print-line.
       ...
       0400-write-file.
           ...
           .
       1000-process-file. 
           if  i-rec(5:19) = table-column-literal 
               move 0 to t-knt1
               inspect i-rec(48:250) tallying t-knt1 for all characters
                                             after  '="'
                                             before  '" '
               move i-rec(79:t-knt1) to column-count
           end-if
           if  i-rec(5:18) = end-row-literal
           ...
           if  i-rec(7:8) = text-p-literal 
               add 1 to col-print-count
               move 0 to t-knt2	
               inspect i-rec(1:300) tallying t-knt2 for all characters
                                             after  'p>'
                                             before  '</'
               move i-rec(15:t-knt2) to print-col(col-print-count) 
           end-if
           perform 0200-read-file
           .
       9000-init.
