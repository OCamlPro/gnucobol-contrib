...
del DB2TEST6.exe    2>NUL
del DB2SQLMSG.dll   2>NUL
del DB2MOD6.dll     2>NUL
del DB2MOD6.bnd     2>NUL
del DB2MOD6.cbl     2>NUL
...
cobc -m -std=mf DB2MOD6.cbl -fnot-reserved=TITLE -Ic:\Programme\IBM\SQLLIB\include\cobol_mf -Lc:\Programme\IBM\SQLLIB\lib -ldb2api
cobc -x DB2TEST6.cob
