...
del DB2TEST4.exe    2>NUL
del DB2SQLMSG.dll   2>NUL
del DB2MOD4.dll     2>NUL
del DB2MOD4.bnd     2>NUL
del DB2MOD4.cbl     2>NUL
...
db2cmd -i -w -c db2 -tvf db2_precompile4.sql
...
cobc -m -std=mf DB2MOD4.cbl -fnot-reserved=TITLE -Ic:\Programme\IBM\SQLLIB\include\cobol_mf -Lc:\Programme\IBM\SQLLIB\lib -ldb2api
cobc -x DB2TEST4.cob
