...
del DB2TEST2.exe    2>NUL
del DB2SQLMSG.dll   2>NUL
del DB2MOD2.dll     2>NUL
del DB2MOD2.bnd     2>NUL
del DB2MOD2.cbl     2>NUL
...
cobc -m -std=mf DB2MOD2.cbl -fnot-reserved=TITLE -Ic:\Programme\IBM\SQLLIB\include\cobol_mf -Lc:\Programme\IBM\SQLLIB\lib -ldb2api
cobc -x DB2TEST2.cob
