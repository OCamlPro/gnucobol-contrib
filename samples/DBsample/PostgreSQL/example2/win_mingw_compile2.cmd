...
del PGTEST2.exe 2>NUL
del PGMOD2.cob  2>NUL

:: SQL precompile
%OC_PRE%\ocesql PGMOD2.cbl PGMOD2.cob

echo Press any key to continue...
pause

:: static compile
cobc -x PGTEST2.cob PGMOD2.cob PGSQLMSG.cob %OC_DBLIB%\ocdb.o %OC_DBLIB%\ocdblog.o %OC_DBLIB%\ocdbutil.o %OC_DBLIB%\ocesql.o %OC_DBLIB%\ocpgsql.o -I%OC_COPY% -L%OC_DBLIB% -locesql -L%PSQL_LIB% -lpq
