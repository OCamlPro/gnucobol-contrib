...
del PGTEST1.exe 2>NUL
del PGMOD1.cob  2>NUL

:: SQL precompile
%OC_PRE%\ocesql PGMOD1.cbl PGMOD1.cob

echo Press any key to continue...
pause

:: static compile
cobc -x PGTEST1.cob PGMOD1.cob PGSQLMSG.cob %OC_DBLIB%\ocdb.o %OC_DBLIB%\ocdblog.o %OC_DBLIB%\ocdbutil.o %OC_DBLIB%\ocesql.o %OC_DBLIB%\ocpgsql.o -I%OC_COPY% -L%OC_DBLIB% -locesql -L%PSQL_LIB% -lpq
