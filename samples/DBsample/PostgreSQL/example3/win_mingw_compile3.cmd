...
del PGTEST3.exe 2>NUL
del PGMOD3.cob  2>NUL

:: SQL precompile
%OC_PRE%\ocesql PGMOD3.cbl PGMOD3.cob

echo Press any key to continue...
pause

:: static compile
cobc -x PGTEST3.cob PGMOD3.cob PGSQLMSG.cob %OC_DBLIB%\ocdb.o %OC_DBLIB%\ocdblog.o %OC_DBLIB%\ocdbutil.o %OC_DBLIB%\ocesql.o %OC_DBLIB%\ocpgsql.o -I%OC_COPY% -L%OC_DBLIB% -locesql -L%PSQL_LIB% -lpq
