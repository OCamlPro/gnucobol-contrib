...
del PGTEST5.exe 2>NUL
del PGMOD5.cob  2>NUL

:: SQL precompile
%OC_PRE%\ocesql PGMOD5.cbl PGMOD5.cob

echo Press any key to continue...
pause

:: static compile
cobc -x PGTEST5.cob PGMOD5.cob PGSQLMSG.cob %OC_DBLIB%\ocdb.o %OC_DBLIB%\ocdblog.o %OC_DBLIB%\ocdbutil.o %OC_DBLIB%\ocesql.o %OC_DBLIB%\ocpgsql.o -I%OC_COPY% -L%OC_DBLIB% -locesql -L%PSQL_LIB% -lpq
