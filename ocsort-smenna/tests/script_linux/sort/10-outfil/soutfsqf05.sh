...
## :: ocsort                                       
$exedir/ocsort TAKE $takedir/soutfsqf05.prm
export rtc1=$?
export dd_infile=
export dd_outfile=
export dd_outfil_01=
...
export dd_inocsort=$filedir/soutfsqf05_ocs01.srt
echo $dd_incobol$
echo $dd_inocsort$
$exedir/diffile
export rtc2=$?
...
if [ $rtc2  -eq 0 ] ; then
    ...
    export dd_inocsort=$filedir/soutfsqf05_ocs02.srt
    echo $dd_incobol$
    echo $dd_inocsort$
    $exedir/diffile
    export rtc2=$?
...
if [ $rtc2 -eq 0 ] ; then
    ...
    export dd_inocsort=$filedir/soutfsqf05_ocs03.srt
    echo $dd_incobol$
    echo $dd_inocsort$
    $exedir/diffile
    export rtc2=$?
