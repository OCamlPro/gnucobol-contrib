...
*>                      also, included LM's (Load Modules) to convert each ISAM
...
*>                      SM903 Write failure on Log File = nn.
*>                      SM904.
*>**
...
*>  to use, WITHOUT the right of ANY FORM OF PAID REDISTRIBUTION is given.
*>  HOWEVER, distribution licensing can be offered on a case by case basis.
*>
...
*>
 ...
 77  prog-name           pic x(17)    value "stockMT (3.02.05)".
*>
...
*>
 01  filler redefines table-of-keynames.
     03  keyOfReference occurs 3    indexed by KOR-x1.
         05 KeyName      pic x(30).
...
*>
 01  Error-Messages.            *> from acas011
     03  ST901           pic x(31) value "SM901 Note error and hit return".
     03  ST903           pic x(34) value "SM903 Write failure on Log File = ".
*>
*> /MYSQL VAR\
*>       ACASDB
*>       TABLE=STOCK-REC,HV
...
*>
       ...
       01  TD-STOCK-REC.
           ...
           05  HV-STOCK-CONSTRUCT-BUNDLE         PIC S9(10) COMP.
           05  HV-STOCK-UNDER-CONSTRUCTION       PIC S9(10) COMP.
           05  HV-STOCK-WORK-IN-PROGRESS         PIC S9(10) COMP.
           05  HV-STOCK-REORDER-PNT              PIC S9(10) COMP.
           05  HV-STOCK-STD-REORDER              PIC S9(10) COMP.
           05  HV-STOCK-BACK-ORDERED             PIC S9(10) COMP.
           05  HV-STOCK-ON-ORDER                 PIC S9(10) COMP.
           05  HV-STOCK-HELD                     PIC S9(10) COMP.
           05  HV-STOCK-PRE-SALES                PIC S9(10) COMP.
...
*>
     ...
     move     STOCK-LOCATION           to HV-STOCK-LOCATION
