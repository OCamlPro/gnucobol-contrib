...
999999     display "Start Program TSTCHDATAL3 ".
999999     display "Check data file created by gcsort_gentestcase"
...
999999     display "End Program TSTCHDATAL3 ".
