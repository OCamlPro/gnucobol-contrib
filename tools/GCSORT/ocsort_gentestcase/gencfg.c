...
// * ----------------------------------------------------
// * ----------------------------------------------------
		if(strncmp(szLine, "gcsort_top_end",14) == 0) {
			b_gcsort_top=0;
			continue;
		}
		if(strncmp(szLine, "gcsort_top_start",16) == 0) {
			b_gcsort_top=1;
			continue;
		}
		if (b_gcsort_top == 1) {
			strcpy(szgcsort_top[n_gcsort_top], szLine);
			n_gcsort_top++;
			continue;
		}
...
// * ----------------------------------------------------
// * ----------------------------------------------------
		if(strncmp(szLine, "gcsort_bottom_end",17) == 0) {
			b_gcsort_bottom=0;
			continue;
		}
		if(strncmp(szLine, "gcsort_bottom_start",19) == 0) {
			b_gcsort_bottom=1;
			continue;
		}
		if (b_gcsort_bottom == 1) {
			strcpy(szgcsort_bottom[n_gcsort_bottom], szLine);
			n_gcsort_bottom++;
			continue;
		}
