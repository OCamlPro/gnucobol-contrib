...
## :: gcsort                                       
$exedir/gcsort TAKE $takedir/soutfsqf01.prm
export rtc1=$?
export dd_infile=
export dd_outfile=
export dd_outfil_01=
...
export dd_ingcsort=$filedir/soutfsqf01_ocs01.srt
echo  $dd_incobol 
echo  $dd_ingcsort 
$exedir/diffile
export rtc2=$?
...
if [ $rtc2 -eq 0 ] ; then
    ...
    export dd_ingcsort=$filedir/soutfsqf01_ocs02.srt
    echo $dd_incobol
    echo $dd_ingcsort
    $exedir/diffile
    export rtc2=$?
...
if [ $rtc2 -eq 0 ] ; then
    ...
    export dd_ingcsort=$filedir/soutfsqf01_ocs03.srt
    echo $dd_incobol
    echo $dd_ingcsort
    $exedir/diffile
    export rtc2=$?
