      ...
      *-------------------------------------------------------------------------------*
       ...
       program-id.  iosqzd01c.
       environment division.
       input-output section.
       file-control.
           select masterseqfile assign to external sqzd01c
      ...
      *   display "======== error ======= "
          ...
          close masterseqfile.
          if (error-flag = zero)
                display " iosqzd01c - check ok "
          else
                display " iosqzd01c - check ko "
          end-if
          display " iosqzd01c - end ".
		  display "*====================*".
       end-proc.
          stop run.
      *       
