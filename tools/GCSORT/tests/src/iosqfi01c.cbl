      ...
      *-------------------------------------------------------------------------------*
       ...
       program-id.  iosqfi01c.
       environment division.
       input-output section.
       file-control.
           select masterseqfile assign to  external sqfi01c
      ...
      *   display "======== error ======= "
          ...
          close masterseqfile.
          if (error-flag = zero)
                display " iosqfi01c - check ok "
          else
                display " iosqfi01c - check ko "
          end-if
          display " iosqfi01c - end ".
		  display "*====================*".
       end-proc.
          stop run.
      *       
