      ...
      *-------------------------------------------------------------------------------*
       ...
       program-id.  iosqbi03c.
       environment division.
       input-output section.
       file-control.
           select masterseqfile assign to external sqbi03c
      ...
      *                
	   ...
	   prdi-00.
          ...
          if (msr-02s not equal zero) 
            display " error on msr-02  =  " msr-02s 
      ...
      *         
          ...
          if (msr-08 not equal check-value)
            display " error on msr-06  =  " msr-08
               move 1 to error-flag
                go err-signed.
          multiply 3333333333  by 2 giving check-value
          if (msr-10 not equal check-value)
            display " error on msr-10  =  " msr-10
               move 1 to error-flag
                go err-signed.
          multiply 66666666666 by 2 giving check-value
          ...
          if (msr-16 not equal check-value)
            display " error on msr-16  =  " msr-16
               move 1 to error-flag
                go err-signed.
          multiply 1111111111111111  by 2 giving check-value
