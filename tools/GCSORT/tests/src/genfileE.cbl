      ...
      * 
       ...
       77       program-name          pic x(12) value "*genfileE*".
      ...
      *
       ...
       set-valuerecord-asc.
           ...
           TRANSFORM   ch-field   FROM  case-ascii        
                                  TO    case-ebcdic      
           TRANSFORM   seq-record FROM  case-ascii        
                                  TO    case-ebcdic  
           TRANSFORM   ch-filler  FROM  case-ascii        
                                  TO    case-ebcdic                                  
           TRANSFORM   zd-field   FROM  case-ascii        
                                  TO    case-ebcdic                                  
           TRANSFORM   clo-field  FROM  case-ascii        
                                  TO    case-ebcdic                                  
