      ...
      *  array-name
       01    array-name.
          03 ar-name-max-ele        pic 99  value 1.
          03 ar-ele-name.
            05 ar-ele-name-01         pic x(10) value 'ixwrite01 '.
            05 ar-ele-name-02         pic x(10) value '          '.
            05 ar-ele-name-03         pic x(10) value '          '.
      ...
      *    
       01  array-pgm-diff.
          03 ar-pgm-name.
            05 ar-pgm-name-01         pic x(10) value 'diffidx   '.
            05 ar-pgm-name-02         pic x(10) value '          '.
            05 ar-pgm-name-03         pic x(10) value '          '.
      ...
      **
       01      array-takefile.
          03   ar-ele-take-num            pic 9(3)  value 4.
          03   ar-ele-take-rows.
           05  ar-ele-take-row-01.
      * 5 -febcdic-table=ebcdic500_latin1 SORT FIELDS=COPY USE ..\files\inpix01.txt   RECORD F,102 ORG SQ  GIVE ..\files\inpix01_gcs.dat RECORD F,100 ORG IX KEY (1,10,P,ASCII,91,10,AD,EBCDIC) 
            07 ar-ele-take-row-01001      pic x(10) value 'ixwrite01 '.
            07 ar-ele-take-row-01002      pic x(52) value  
             '     '.
            07 ar-ele-take-row-01003      pic x(10) value 'ixwrite01 '.
            07 ar-ele-take-row-01004      pic x(52) value  
             ' SORT FIELDS=COPY USE dd_infile RECORD F,102 ORG SQ'.
            07 ar-ele-take-row-01005      pic x(10) value 'ixwrite01 '.
            07 ar-ele-take-row-01006      pic x(52) value  
             ' GIVE dd_outfile RECORD F,100'.
            07 ar-ele-take-row-01007      pic x(10) value 'ixwrite01 '.
            07 ar-ele-take-row-01008      pic x(52) value  
             ' ORG IX KEY (1,10,P,91,10,AD,EBCDIC)      '.
            07 ar-ele-take-row-01009      pic x(10) value  space.
            07 ar-ele-take-row-01010      pic x(52) value  space.

      * 5
            07 ar-ele-take-row-02001      pic x(10) value '    '.
            07 ar-ele-take-row-02002      pic x(52) value  
             ' SORT FIELDS=(1,15,CH,D)                          '.
            07 ar-ele-take-row-02003      pic x(10) value '    '.
            07 ar-ele-take-row-02004      pic x(52) value  
             ' USE  dd_infile   RECORD F,100 ORG LSF             '.
            07 ar-ele-take-row-02005      pic x(10) value '    '.
            07 ar-ele-take-row-02006      pic x(52) value  
             ' GIVE dd_outfile  RECORD F,100 ORG LSF             '.
            07 ar-ele-take-row-02007      pic x(10) value '    '.
      ...
      * 5
            07 ar-ele-take-row-03001      pic x(10) value '    '.
            07 ar-ele-take-row-03002      pic x(52) value  
             ' SORT FIELDS=(1,15,CH,D)                          '.
            07 ar-ele-take-row-03003      pic x(10) value '    '.
            07 ar-ele-take-row-03004      pic x(52) value  
             ' USE  dd_infile   RECORD F,100 ORG LSF             '.
            07 ar-ele-take-row-03005      pic x(10) value '    '.
            07 ar-ele-take-row-03006      pic x(52) value  
             ' GIVE dd_outfile  RECORD F,100 ORG LSF             '.
            07 ar-ele-take-row-03007      pic x(10) value '    '.
      ...
      *
           perform exec-all-gr08 varying idx from 1 by 1
                  until idx > ar-name-max-ele
      *
           perform epilog-gr08
           perform epilog-calculate-gr08
      ...
      *** debug         
           ...
           perform genfile-input-gr08
           perform sort-cbl-gr08a
           perform sort-gc-gr08
debug *         perform display-takefile-gr08
           perform diffile-gr08a
           display '*===============================================*'
...
TEST00***               display ' cmd:>' cmd-go  '<'
      ...
      ** set dd_outfile=%filedir%\susesqf01_gcs.srt
           ...
           move space                    to env-set-value
           string '../files/inpix01_gcs.dat'       delimited by size
                    into env-set-value
           perform set-value-env
      *     
      ...
      *    
           perform write-takefile-gr08 
           close fcmd
      ** 
           move space              to cmd-string
           string  'gcsort -febcdic-table=ebcdic500_latin1 '
                        delimited by size
                   'TAKE ../takefile/tmp/'
                                  delimited by size
                   ar-ele-vet(idx)  delimited by space
...
TEST00***               display ' cmd:>' cmd-go  '<'
      ...
      *
      *---------------------------------------------------------*
       display-takefile-gr08        section.
      *---------------------------------------------------------*
       disp-00.
           perform display-takerecord-gr08 varying idx-take
      ...
      * 
      *---------------------------------------------------------*
       display-takerecord-gr08      section. 
      *---------------------------------------------------------*
       dstr-00.
      ...
      *
      *---------------------------------------------------------*
       write-takefile-gr08        section.
      *---------------------------------------------------------*
       wrta-00.
           perform write-takerecord-gr08 varying idx-take
               from 1 by 1 until (idx-take > ar-ele-take-num) 
           .    
       wrta-99.
           exit.
