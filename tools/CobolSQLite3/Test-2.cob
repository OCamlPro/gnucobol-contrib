...
>>D display "- opening database ./test.sdb" end-display

  call "C$DELETE" using "./test.sdb",
                        0 *> required but unused
  end-call

  move DBOPEN("./test.sdb") to db-object
...
>>D display "- closing database ./test.sdb" end-display
