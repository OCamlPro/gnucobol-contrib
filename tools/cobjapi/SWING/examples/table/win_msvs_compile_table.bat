...
cobc -x -free %verbose% -I"%src_cobol_dir%" table1.cob %* %COBCOBJ% %COBCLIB%
cobc -x -free %verbose% -I"%src_cobol_dir%" table2.cob %* %COBCOBJ% %COBCLIB%
cobc -x -free %verbose% -I"%src_cobol_dir%" table3.cob %* %COBCOBJ% %COBCLIB%
