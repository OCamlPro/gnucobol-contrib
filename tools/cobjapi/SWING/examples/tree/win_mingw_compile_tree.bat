...
cobc -x -free -Wno-unfinished %verbose% -I"%src_cobol_dir%" tree1.cob %* %COBCOBJ% %COBCLIB%
cobc -x -free -Wno-unfinished %verbose% -I"%src_cobol_dir%" tree2.cob %* %COBCOBJ% %COBCLIB%
cobc -x -free -Wno-unfinished %verbose% -I"%src_cobol_dir%" tree3.cob %* %COBCOBJ% %COBCLIB%
cobc -x -free -Wno-unfinished %verbose% -I"%src_cobol_dir%" tree4.cob %* %COBCOBJ% %COBCLIB%
