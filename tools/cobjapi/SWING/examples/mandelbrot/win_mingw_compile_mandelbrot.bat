...
echo compile the programs
cobc -x -free -Wno-unfinished %verbose% -I"%src_cobol_dir%" mandelbrot1.cob %* %COBCOBJ% %COBCLIB%
cobc -x -free -Wno-unfinished %verbose% -I"%src_cobol_dir%" mandelbrot2.cob %* %COBCOBJ% %COBCLIB%
cobc -x -free -Wno-unfinished %verbose% -I"%src_cobol_dir%" mandelbrot3.cob %* %COBCOBJ% %COBCLIB%
