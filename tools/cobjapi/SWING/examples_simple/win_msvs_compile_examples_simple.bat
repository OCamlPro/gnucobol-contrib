...
cobc -x -free %verbose% -I"%src_cobol_dir%" internalframe1.cob    %* %COBCOBJ% %COBCLIB% 
cobc -x -free %verbose% -I"%src_cobol_dir%" internalframe2.cob    %* %COBCOBJ% %COBCLIB% 
...
cobc -x -free %verbose% -I"%src_cobol_dir%" splitpane.cob         %* %COBCOBJ% %COBCLIB% 
