...
public class JAPI_MultiLineLabel extends Canvas {
    ...
    public JAPI_MultiLineLabel(String label, int margin_width, int margin_height,
                  int alignment) {
        newLabel(label);
    ...
    public JAPI_MultiLineLabel(String label, int alignment) {
        this(label, 10, 10, alignment);
    }
    public JAPI_MultiLineLabel(String label) {
        this(label, 10, 10, LEFT);
    }
    public JAPI_MultiLineLabel() {
        this("", 10, 10, LEFT);
    }
