       ...
       program-id.   secsbdt2.
      *************************************************************
      **** returns a signed 31 byte number of seconds between two valid
      **** dates and times. passed as 4 arguments:
      **** ccyymmdd hhmmss ccyymmdd hhmmss
      **** compile: cobc -x secsbdt2.cbl -std=mf
      **** run example: secsbdt2 20010101 010230 20240202 235959
      **** returns from sysout on next line: +0000000000000000000000728607449 
