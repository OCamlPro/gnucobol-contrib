       ...
       program-id.    sbrdatey.                               
      *************************************************
      **** input parameter will be subtracted from current date
      **** returns date X days before run date.
      **** compile: cobc -m sbrdatey.cbl -std=mf
      **** two parameters.
      **** 1. number days to subtract from current date 
      **** 2. returned new date with arithmetic applied
      **** called from other program passing number of days
      **** in seven-inx parameter to be subtracted from the current date
      **** returns new date X days before current date
