...
*>
*>  p001_wortfee_login_param.cpy is free software: you can redistribute it and/or
*>  modify it under the terms of the GNU Lesser General Public License as
*>  published by the Free Software Foundation, either version 3 of the License,
*>  or (at your option) any later version.
*>
*>  p001_wortfee_login_param.cpy is distributed in the hope that it will be useful,
*>  but WITHOUT ANY WARRANTY; without even the implied warranty of
*>  MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.
*>  See the GNU Lesser General Public License for more details.
*>
*>  You should have received a copy of the GNU Lesser General Public License
*>  along with p001_wortfee_login_param.cpy.
*>  If not, see <http://www.gnu.org/licenses/>.
*>******************************************************************************

*>******************************************************************************
*> Copy file:    p001_wortfee_login_param.cpy
*>
...
*> testing, never use it in online system! 
 01 HTM2COB-DEBUG-FLAG          GLOBAL PIC 9(1) VALUE 0.
...
*> POST together.
 01 HTM2COB-REQUEST-METHOD-FLAG        PIC 9(1) VALUE 0.
...
*> relevant. (bytes)
 78 HTM2COB-QUERY-STR-MAX-LEN          VALUE 1.
*> Max POST data length together with upload file size. (bytes)
 78 HTM2COB-CONTENT-MAX-LEN            VALUE 1.
*> Max upload file size. (bytes)
 78 HTM2COB-UPLOAD-FILE-MAX-SIZE       VALUE 1.
...
*> names without values.
 78 HTM2COB-TAB-MAX-LINE        GLOBAL VALUE 1.
...
*> input field "hidden_session_id".
 01 HTM2COB-USE-SESS-COOKIE-FLAG       PIC 9(1) VALUE 1.
...
*> environment variable DB_HOME to where your session files are saved.
 01 HTM2COB-DB-HOME             GLOBAL PIC X(1024) VALUE "/home/wortfee".
*> File path for the session file. 
 01 HTM2COB-SESSION-FILE        GLOBAL PIC X(1024) VALUE "/home/wortfee/p001_session.dat".
*> File path for the session variable file. 
 01 HTM2COB-SESSION-VAR-FILE    GLOBAL PIC X(1024) VALUE "/home/wortfee/p001_session_var.dat".
*> Max time after first request. The session will be deleted after this time.
*>  1h =  3600 sec
*>  4h = 14400 sec
*> 24h = 86400 sec
 01 HTM2COB-FIRST-REQ-DIFF-SEC         PIC 9(18) VALUE 86400.
