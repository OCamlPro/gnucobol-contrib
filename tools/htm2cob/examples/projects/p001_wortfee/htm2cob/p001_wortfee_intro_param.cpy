...
*>
*>  p001_wortfee_intro_param.cpy is free software: you can redistribute it and/or
*>  modify it under the terms of the GNU Lesser General Public License as
*>  published by the Free Software Foundation, either version 3 of the License,
*>  or (at your option) any later version.
*>
*>  p001_wortfee_intro_param.cpy is distributed in the hope that it will be useful,
*>  but WITHOUT ANY WARRANTY; without even the implied warranty of
*>  MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.
*>  See the GNU Lesser General Public License for more details.
*>
*>  You should have received a copy of the GNU Lesser General Public License
*>  along with p001_wortfee_intro_param.cpy.
*>  If not, see <http://www.gnu.org/licenses/>.
*>******************************************************************************

*>******************************************************************************
*> Copy file:    p001_wortfee_intro_param.cpy
*>
...
*> POST together.
 01 HTM2COB-REQUEST-METHOD-FLAG        PIC 9(1) VALUE 1.
...
*> Max POST data length together with upload file size. (bytes)
 78 HTM2COB-CONTENT-MAX-LEN            VALUE 600.
...
*> size. For special chars you need 2 or 3 bytes. (bytes)
 78 HTM2COB-DATA-VALUE-MAX-LEN         VALUE 600.
