      ...
      *>        UNSIGNED                                             **
      *>                                                             **
      * 2022-08-07 Extend GC's great work by adding optional file out** fcsisat
      *                                                              **
      *>***************************************************************
       ENVIRONMENT DIVISION.
      *
      * The next three lines are commented out so the program can be
      * included in a lib*.so.  Un-comment for free-standing compile.
      ...
      *
       DATA DIVISION.
       FILE SECTION.
       FD  DUMPFILE          LABEL RECORDS ARE STANDARD.
