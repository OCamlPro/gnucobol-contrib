...
*>     >>SOURCE FREE|FIXED starting in Column 8
*>
*> Error messages used.
...
*>    needed BUT the version of cobmysqlapi39 or 38
*>     MUST be used and this is included in the archive.
*>
...
*>   This version is heavily modifled to include extra functions
*>   and is now at release 3.8.
*>
...
*>            presql2M(aria) for MariaDB has one more column in
*>             information_schema and one for
...
*>
*> 220729 vbc - 2.30 - Start coding to support exec sql for ODBC, mysql
*>              and other DBMS such as Postgres and may be
*>              DB/2 and oracle subject to requests/demand etc.
*>              On completion version will be v3.0.
*>              source saved as presql2.3.cbl
*>              Changed format to FREE as presql2.230-free.cbl
*>
*>              This release supports usage of $SET SQL xxxxx
*>              where xxxxx = rdbms being used hopefully
*>              supported is :
*>              ODBC
*>              mysql
*>              mariadb (Drop in compatable for user programs)
*>              NOTE THAT $SET SQL MUST be with only one space
*>              BETWEEN WORDS $SET and SQL and again for MYSQL, ODBC,
*>              MARIADB   etc.
*>
*>****************************************************************
*>
...
*>***************************************************
 01  WS-NAME-PROGRAM.
     03  WS-Program-Name              pic x(7) value "presql2".
     03  ws-Prog-Version              pic x(6) value " 2.3  ".
*>> needed 4 read-params call.
 01  ws-parm-prog-name                pic x(7) value "presql2".
*>
...
*>
 ...
 01  WS-LLength                       pic 9(4)  comp value zero.
 01  WS-A                             PIC 9(4)  COMP value zero.
 01  WS-B                             PIC 9(4)  COMP value zero.
 01  WS-C                             PIC 9(4)  COMP value zero.
 01  WS-D                             PIC 9(4)  COMP value zero.
 01  WS-Line-Length                   pic 9(4)  comp value zero.
...
*> 01  WS-L                             PIC S9(4) COMP.
 ...
 01  ws-Source-Format                 pic x(5)      value "FIXED".
     88  Source-Fixed                       value "FIXED" "fixed".
     88  Source-Free                        value "FREE" "free".
 01  WS-Comment-Found                 PIC 9          value zero.
...
*> 01  WS-SWITCH-INIT                   PIC X          VALUE "N".
 ...
 01  WS-TEMP-TABLE-NAME               PIC X(64).
 01  WS-COLUMN-WANTED                 PIC X(64).
*> 01  WS-TEMP-COLUMN-NAME              PIC X(32).
 01  WS-TEMP-COLUMN-NAME              PIC X(27).
...
*>
*> 01  CC-MYSQL-HOST-NAME               PIC X(64).
*> 01  CC-MYSQL-IMPLEMENTATION          PIC X(64).
*> 01  CC-MYSQL-PASSWORD                PIC X(64).
*> 01  CC-MYSQL-BASE-NAME               PIC X(64).
*> 01  CC-MYSQL-PORT-NUMBER             PIC X(4).
*> 01  CC-MYSQL-SOCKET                  PIC X(64).
*>
*>
 01  Warning-Messages.
     03  PSW001  pic x(27) value "PSW001 Input file not found".
     03  PSW002  pic x(53) value "PSW002 Input & Output file names must not be the same".
     03  PSW003  pic x(17) value " Beginning at -- ".
     03  PSW004  pic x(26) value " Completed normally at -- ".
 01  Error-Messages.
     03  PSE001  pic x(39) value "PSE001 Cannot open output file, Status=".
     03  PSE002  pic x(42) value "PSE002 Un-Terminated /MYSQL VAR\ Construct".
     03  PSE003  pic x(49) value "PSE003 Must have base statement after /MYSQL VAR\".
         *>>" Stops my editor using red text as does not like slashes etc.
     03  PSE004  pic x(33)  value "PSE004 Invalid command at record=".
     03  PSE005  pic x(39)  value "PSE005 Table prefix too long at record=".
     03  PSE006  pic x(36)  value "PSE006 Invalid table spec at record=".
     03  PSE007  pic x(26)  value "PSE007 More than 32 Tables".
     03  PSE008A pic x(14)  value "PSE008 Table '".
     03  PSE008B pic x(41)  value "' Does not exist in MYSQL VAR Definition ".
     03  PSE009A pic x(39)  value "PSE009 Unsupported data type in column ".
     03  PSE009B pic x(10)  value " of Table=".
     03  PSE010A pic x(35)  value "PSE010 Cannot handle data type for ".
     03  PSE010B pic x(12)  value " DataType = ".
     03  PSE011  pic x(43)  value "PSE011 Input file NOT available at 2090-EOF".
     03  PSE012  pic x(41)  value "PSE012 No table for MYSQL DEFINE at line=".
     03  PSE013  pic x(39)  value "PSE013 Table prefix too long at record=".
     03  PSE014  pic x(30)  value "PSE014 Invalid spec at record=".
     03  PSE015A pic x(23)  value "PSE015 Table not found=".
     03  PSE015B pic x(11)  value " at record=".
     03  PSE016  pic x(41)  value "PSE016 No table for MYSQL DELETE at line=".
     03  PSE017  pic x(23)  value "PSE017 Table not found=".
     03  PSE018  pic x(42)  value "PSE018 Nowhere for MYSQL DELETE at record=".
     03  PSE019  pic x(40)  value "PSE019 No table for MYSQL FETCH at line=".
     03  PSE020  pic x(39)  value "PSE020 No table for MYSQL FREE at line=".
     03  PSE021  pic x(40)  value "PSE021 No base name specified at record=".
     03  PSE022  pic x(41)  value "PSE022 No table for MYSQL INSERT at line=".
     03  PSE023  pic x(41)  value "PSE023 No table for MYSQL SELECT at line=".
     03  PSE024  pic x(42)  value "PSE024 Nowhere for MYSQL SELECT at record=".
     03  PSE025  pic x(41)  value "PSE025 No table for MYSQL UPDATE at line=".
     03  PSE026  pic x(42)  value "PSE026 Nowhere for MYSQL UPDATE at record=".
     03  PSE027  pic x(60)  value
                "PSE027 Must have BASE statement after /MYSQL VAR\ at record=".
     03  PSE028  pic x(27)  value "PSE028 Could not find BASE=".
     03  PSE029  pic x(39)  value "PSE029 No table for MYSQL LOCK at line=".
...
*>
 01  COLUMN-BUFFER.
     ...
     05  CB-COLUMN-TYPE               PIC X(4096).  *> New - vbc
...
*>
 ...
 01  WS-COLUMN-ARRAY-BUFFER.
     ...
     05  WS-CA-COLUMN-TYPE            PIC X(32)      occurs 1024.
...
*>    if       function UPPER-CASE (ws-name-input-file)
*>                              not = "HELP"
...
*>
     if       function UPPER-CASE (ws-name-input-file) = "HELP"
              ...
              display " P1 is compulsory"
              display " P2 missing o/p = input name + '.cbl' "
...
*>
*> Hack to build a missing P2 from P1 if needed.
*>
     if       ws-name-output-file = spaces
       and    ws-name-input-file not = spaces
              string  ws-name-input-file delimited by "."
                                  ".cbl" delimited by size
                   into ws-name-output-file
              end-string
     end-if
*>
 ...
 1004-Error-Non-Zero.
     IF       WS-OUTPUT-FILE-STATUS not = ZERO
              DISPLAY PSE001 WS-OUTPUT-FILE-STATUS
              close Input-File
              STOP RUN.
*>
 1005-Init.
*>     INITIALIZE WS-TABLES-USED.       *>> Done earlier
     display  WS-NAME-PROGRAM " compiling " ws-name-input-file.
...
*>
*>  Added TRIM code in case it does not start in cc8
*>   also check for $SET and set value in WS-Set-Values
*>
     if       WS-Record-Number < 3
              move     spaces to WS-IR-Buffer   *>> JIC
              move     function TRIM (IR-Buffer) to WS-IR-Buffer
              if       function UPPER-CASE (WS-IR-Buffer (1:14)) = ">>SOURCE FREE "
              or       function UPPER-CASE (WS-IR-Buffer (1:21)) = ">>SOURCE FORMAT FREE "
              or       function UPPER-CASE (WS-IR-Buffer (1:24)) = ">>SOURCE FORMAT IS FREE "
                       move     "FREE" to ws-Source-Format
                       go to 2000-Process
              end-if
              if       function UPPER-CASE (WS-IR-Buffer (1:14)) = ">>SOURCE FIXED"
              or       function UPPER-CASE (WS-IR-Buffer (1:21)) = ">>SOURCE FORMAT FIXED"
              or       function UPPER-CASE (WS-IR-Buffer (1:24)) = ">>SOURCE FORMAT IS FIXED"
                       move     "FIXED" to ws-Source-Format
                       go to 2000-Process
              end-if
*>
*> Test for $SET SQL xxxxxx >>>> NEED TO CHECK THIS
*>
              if       function UPPER-CASE (WS-IR-Buffer (1:8)) = "$SET SQL"
                       move     function TRIM (WS-IR-Buffer, LEADING)   to WS-Temp-IR-Buffer
                       move     function UPPER-CASE (WS-Temp-IR-Buffer) to WS-Temp-IR-Buffer
                       ...
                       display  WS-Temp-IR-Buffer (1:10) "Invalid Param in $SET SQL"
                       display  "Aborting"
                       close    Input-File
                       stop     run
              end-if
...
*>
     ...
     if       Source-Free
              move WS-LLength to ws-Line-Length.
*>
     MOVE ZERO TO WS-I.
     INSPECT IR-BUFFER (1:ws-Line-Length)
             TALLYING WS-I FOR ALL "/MYSQL VAR\". *>>"
     IF      WS-I not = zero         *>> Could have more than one !
...
*>
 ...
 2118-CONTINUE.
     ...
     IF       WS-TABLE-ARRAY-HIGH-POINT > 32
              DISPLAY PSE007
              close input-file output-file
              STOP RUN.
     GO TO 2110-READ-LOOP.
...
*>
 ...
 2132-TABLE-LOOP.
     ...
     MOVE     SPACE TO WS-MYSQL-COMMAND.
...
*>               WS-TABLE-ARRAY (WS-I) DELIMITED BY SIZE,
              '"',
              X"00"
...
*>
     ...
     IF       WS-MYSQL-COUNT-ROWS < 1
              THEN DISPLAY PSE008A
                        FUNCTION TRIM(WS-TABLE-ARRAY ( WS-I ))
                     PSE008B
>>D                     "=" ws-i
              close input-file output-file
 ...
 2134-COLUMN-LOOP.
     ...
     IF RETURN-CODE = -1
       ADD 1 TO WS-I
       IF WS-I > WS-TABLE-ARRAY-HIGH-POINT
...
*>      WHEN "text"
     ...
     move CB-COLUMN-TYPE   to WS-CA-COLUMN-TYPE (WS-J).
     ADD 1 TO WS-J.
...
*>
 2140-CONTINUE.
     ...
     MOVE 1 TO WS-I.
>>D      display "D=  WS-I=", WS-I.
>>D      display "D=  WS-CA-DATA-TYPE=" WS-CA-DATA-TYPE (WS-I).
>>D      display "D=  WS-CA-COLUMN-TYPE=" WS-CA-COLUMN-TYPE (WS-I).
*>
 2142-FIELD-LOOP.
*>
*>   First evaluate for
...
*>
     ...
     EVALUATE WS-CA-DATA-TYPE (WS-I)
       ...
       WHEN "tinyint"
         ...
         move zero to ws-A
         inspect  ws-ca-column-type (WS-I)
                  tallying ws-A for all "unsigned"
         if ws-A = zero
               move "PIC S9(XX) COMP" to ws-ca-picture (WS-I)
         else
               move "PIC  9(XX) COMP" to ws-ca-picture (WS-I)
         end-if
...
*>
 3000-CLOSE.
     ...
     WRITE OUTPUT-RECORD.
     MOVE "           PERFORM MYSQL-1980-CLOSE THRU MYSQL-1999-EXIT" TO OR-BUFFER.
     WRITE OUTPUT-RECORD.
     ...
     MOVE     ZERO TO WS-I.
     INSPECT IR-BUFFER TALLYING WS-I FOR ALL "/MYSQL-END\". *>"
     IF WS-I not = 1 GO TO 5000-ERROR.
     PERFORM 5100-OUTPUT-COMMENT THRU 5109-EXIT.
     GO TO 2810-READ.
*>
...
*>
 ...
 3052-FINISHED.
     ADD 1 TO WS-J.
     IF WS-J < 65 GO TO 3051-PARSE-LOOP.
     IF WS-TABLE-WANTED = SPACES GO TO 3053-ERROR.
     IF WS-TABLE-PREFIX-WORK = SPACES GO TO 3053-ERROR.
     GO TO 3054-CONTINUE.
 3053-ERROR.
     MOVE     WS-RECORD-NUMBER TO WS-ED6S.
     DISPLAY  PSE014 WS-ED6S.
     close    input-file output-file
     STOP RUN.
 3054-CONTINUE.
     MOVE 1 TO WS-I.
 3056-TABLE-LOOP.
     IF WS-TABLE-WANTED = WS-TABLE-ARRAY (WS-I)
       THEN GO TO 3057-DEFINE.
     ADD 1 TO WS-I.
     IF       WS-I not > WS-TABLE-ARRAY-HIGH-POINT
              GO TO 3056-TABLE-LOOP
       ELSE   DISPLAY PSE015A WS-TABLE-WANTED,
                      PSE015B WS-RECORD-NUMBER
              close input-file output-file
              STOP RUN.
 3057-DEFINE.
     MOVE WS-TABLE-START (WS-I) TO WS-J.
 3058-COLUMN-LOOP.
     MOVE WS-CA-COLUMN-NAME (WS-J) TO WS-TEMP-COLUMN-NAME.
     PERFORM 5300-FIX-INTERIM-SPACES THRU 5390-EXIT.
...
*>      FUNCTION TRIM (WS-CA-COLUMN-NAME (WS-J))
       FUNCTION TRIM (WS-TEMP-COLUMN-NAME)
         INTO OR-BUFFER.
*>    MOVE 46 TO WS-K.
     MOVE 50 TO WS-K.
     STRING
...
*>
 ...
 3102-TABLE-LOOP.
     ...
     IF       WS-I not > WS-TABLE-ARRAY-HIGH-POINT
       ...
       ELSE   DISPLAY PSE017 WS-TABLE-WANTED,
                      PSE015B WS-RECORD-NUMBER
              close input-file output-file
              STOP RUN.
 3104-DELETE.
     INITIALIZE OR-BUFFER.
     MOVE '           INITIALIZE WS-MYSQL-COMMAND'
       TO OR-BUFFER.
     WRITE OUTPUT-RECORD.
...
*>      '"'
 ...
 3106-READ-LOOP.
     ...
     IF WS-I = 1
       ...
       WRITE OUTPUT-RECORD
       INITIALIZE OR-BUFFER
       MOVE '             X"00" INTO WS-MYSQL-COMMAND'
         TO OR-BUFFER
       WRITE OUTPUT-RECORD
...
*>
 ...
 3204-PROCESS-COLUMNS.
     INITIALIZE OR-BUFFER.
     MOVE WS-TABLE-WANTED TO WS-TEMP-TABLE-NAME.
     INSPECT WS-TEMP-TABLE-NAME REPLACING ALL " " BY "-".
     INSPECT WS-TEMP-TABLE-NAME REPLACING TRAILING "-" BY " ".
     STRING "           MOVE TP-"
*>      FUNCTION UPPER-CASE (FUNCTION TRIM (WS-TABLE-WANTED))
       FUNCTION UPPER-CASE (FUNCTION TRIM (WS-TEMP-TABLE-NAME))
       " TO WS-MYSQL-RESULT"
         INTO OR-BUFFER.
     INSPECT OR-BUFFER REPLACING ALL "_" BY "-".
     WRITE OUTPUT-RECORD.
...
*>      FUNCTION TRIM (WS-CA-COLUMN-NAME (WS-J))
     ...
     INITIALIZE OR-BUFFER.
*>     MOVE "." TO OR-BUFFER (20:1)
     move     " end-call" to OR-BUFFER (20:9)
     WRITE OUTPUT-RECORD.
     move     spaces to INPUT-RECORD.
     READ     INPUT-FILE NEXT RECORD AT END
              GO TO 5000-ERROR.
...
*>      FUNCTION UPPER-CASE (FUNCTION TRIM (WS-TABLE-WANTED))
     ...
     WRITE OUTPUT-RECORD.
     INITIALIZE OR-BUFFER.
     MOVE '           CALL "MySQL_free_result USING WS-MYSQL-RESULT end-call"'
                      TO OR-BUFFER.
     WRITE OUTPUT-RECORD.
     move     spaces to INPUT-RECORD.
     READ     INPUT-FILE NEXT RECORD AT END
...
*>
 ...
 3402-INIT-LOOP.
     ...
     IF WS-I = 1
       PERFORM 5100-OUTPUT-COMMENT THRU 5109-EXIT
       MOVE FUNCTION SUBSTITUTE (IR-BUFFER, "HOST=", " ") TO IR-BUFFER
     ...
     IF WS-I = 1
       PERFORM 5100-OUTPUT-COMMENT THRU 5109-EXIT
       MOVE FUNCTION
         SUBSTITUTE (IR-BUFFER, "IMPLEMENTATION=", " ") TO IR-BUFFER
     ...
     IF WS-I = 1
       PERFORM 5100-OUTPUT-COMMENT THRU 5109-EXIT
       MOVE FUNCTION
         SUBSTITUTE (IR-BUFFER, "PASSWORD=", " ") TO IR-BUFFER
     ...
     IF WS-I = 1
       PERFORM 5100-OUTPUT-COMMENT THRU 5109-EXIT
       MOVE FUNCTION SUBSTITUTE (IR-BUFFER, "PORT=", " ") TO IR-BUFFER
     ...
     IF WS-I = 1
       PERFORM 5100-OUTPUT-COMMENT THRU 5109-EXIT
       MOVE FUNCTION SUBSTITUTE (IR-BUFFER, "SOCKET=", " ") TO IR-BUFFER
     ...
     IF WS-I = 1
       THEN NEXT SENTENCE
       ELSE GO TO 5000-ERROR.
     IF       WS-SWITCH-GOT-BASE not = "Y"
              DISPLAY PSE021 WS-RECORD-NUMBER
              close input-file output-file
              STOP RUN.
     IF       WS-HOST = SPACES
              MOVE "localhost" to WS-HOST.
     IF       WS-IMPLEMENTATION = SPACES
              MOVE "mysql" TO WS-IMPLEMENTATION.
     IF       WS-PORT = SPACES
              MOVE "3306"  to WS-Port.
     IF       WS-SOCKET = SPACES
              MOVE "/var/run/mysqld/mysqld.sock" to WS-Socket.
     INITIALIZE OR-BUFFER.
     IF WS-RUNTIME = "N"
       STRING
         '           MOVE "'
     ...
     STRING
       ...
       '" & X"00" TO WS-MYSQL-IMPLEMENTATION'
         INTO OR-BUFFER.
     WRITE OUTPUT-RECORD.
     INITIALIZE OR-BUFFER.
     IF WS-RUNTIME = "N"
...
*>      " SET '"
     ...
     MOVE "              INTO WS-MYSQL-COMMAND"
       TO OR-BUFFER.
     WRITE OUTPUT-RECORD.
     MOVE "              WITH POINTER WS-MYSQL-I end-string"
       TO OR-BUFFER.
     WRITE OUTPUT-RECORD.
     ...
     WRITE OUTPUT-RECORD.
     INITIALIZE OR-BUFFER.
     STRING '             WITH POINTER WS-MYSQL-I end-string'
       INTO OR-BUFFER.
     WRITE OUTPUT-RECORD.
     INITIALIZE OR-BUFFER.
...
*>      " SET '"
     ...
     IF       WS-I = 1
       THEN   IF  WS-SWITCH-GOT-WHERE = "N"
                  display PSE026 WS-RECORD-NUMBER
                  close input-file output-file
                  STOP RUN
              END-IF
              PERFORM 5100-OUTPUT-COMMENT THRU 5109-EXIT
 ...
 3910-READ-LOOP.
     ...
     if       Source-Free
              ...
              if      Comment-Found
                      PERFORM 5100-OUTPUT-COMMENT THRU 5109-EXIT
                      GO TO 3910-READ-LOOP.
     IF WS-SWITCH-FOUND-BASE = "Y" GO TO 3914-CONTINUE.
     MOVE ZERO TO WS-I.
     INSPECT IR-BUFFER TALLYING WS-I FOR ALL "BASE=".
     IF       WS-I = 1
              if       Source-fixed
      ...
      ELSE    DISPLAY PSE027 WS-RECORD-NUMBER
              close input-file output-file
              STOP RUN
     END-IF.
     MOVE 1 TO WS-J.
 3912-FIND-BASE.
     IF WS-BASE-WANTED = WS-BASE-NAME-ARRAY (WS-J)
       GO TO 3914-CONTINUE.
     ADD 1 TO WS-J.
     IF       WS-I < WS-TABLE-ARRAY-HIGH-POINT
              GO TO 3912-FIND-BASE.
     DISPLAY  PSE028  WS-BASE-WANTED
              PSE015B WS-RECORD-NUMBER
     close input-file output-file
     STOP RUN.
 3914-CONTINUE.
...
*>
     ...
     MOVE WS-J  TO WS-I.
 3950-TABLE-LOOP.
     IF WS-BASE-WANTED not = WS-BASE-NAME-ARRAY (WS-I)
       PERFORM 5100-OUTPUT-COMMENT THRU 5109-EXIT
       GO TO 2810-READ.
     if       Source-Fixed
              MOVE "      *>" TO OR-BUFFER
     ...
     WRITE OUTPUT-RECORD.
     INITIALIZE OR-BUFFER.
     MOVE WS-TABLE-ARRAY (WS-I) TO WS-TEMP-TABLE-NAME.
     INSPECT WS-TEMP-TABLE-NAME REPLACING ALL " " BY "-".
     INSPECT WS-TEMP-TABLE-NAME REPLACING TRAILING "-" BY " ".
     STRING
       "       01  TP-"
*>      FUNCTION TRIM (WS-TABLE-ARRAY (WS-I))
       FUNCTION TRIM (WS-TEMP-TABLE-NAME)
         INTO OR-BUFFER.
*>    MOVE "USAGE POINTER." TO OR-BUFFER (46:14).
     MOVE "USAGE POINTER." TO OR-BUFFER (50:14).
     MOVE FUNCTION UPPER-CASE (OR-BUFFER) TO OR-BUFFER.
     INSPECT OR-BUFFER REPLACING ALL "_" BY "-".
     WRITE OUTPUT-RECORD.
     INITIALIZE OR-BUFFER.
...
*>
 4100-UNLOCK.
     ...
     WRITE OUTPUT-RECORD.
     MOVE '             X"00" INTO WS-MYSQL-COMMAND end-string'
       TO OR-BUFFER.
     WRITE OUTPUT-RECORD.
     MOVE '           PERFORM MYSQL-1210-COMMAND'
       & ' THRU MYSQL-1219-EXIT'
...
*>    MOVE WS-COLUMN-WANTED TO WS-TEMP-COLUMN-NAME.
*>    PERFORM 5300-FIX-INTERIM-SPACES THRU 5390-EXIT.
*>    MOVE WS-TEMP-COLUMN-NAME TO WS-COLUMN-WANTED.
     INITIALIZE OR-BUFFER.
*>    STRING "           STRING '"
     STRING "           STRING '`"
       FUNCTION TRIM (WS-CA-COLUMN-NAME (WS-J))
...
*>
         ...
         INITIALIZE OR-BUFFER
*>
         IF WS-CA-NUMERIC-SCALE (WS-J) not = ZERO
           THEN MOVE WS-CA-NUMERIC-SCALE (WS-J) TO WS-ED2
                ...
                WRITE OUTPUT-RECORD
                INITIALIZE OR-BUFFER
                STRING "             WITH POINTER WS-MYSQL-I" &
                       " end-string"
                  INTO OR-BUFFER
                WRITE OUTPUT-RECORD
                INITIALIZE OR-BUFFER
 ...
 5290-EXIT.
     EXIT.
*>
*>    Replaces spaces in column names with "-" for COBOL
*>      Variable names
*>
 5300-FIX-INTERIM-SPACES.
     INSPECT WS-TEMP-COLUMN-NAME REPLACING ALL " " BY "-".
     INSPECT WS-TEMP-COLUMN-NAME REPLACING TRAILING "-" BY " ".
 5390-EXIT.
     EXIT.
*>
*>    END OF JOB
...
*>             FUNCTION CURRENT-DATE.
 9990-EXIT.
     EXIT.
*>
 COPY "MYSQL-PROCEDURES.CPY".   *> fixed format used
