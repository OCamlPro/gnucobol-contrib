...
*>   version 008--Moved param block to end of WS area       *
*>                16/06/2023 -- Vincent Coen                *
*>                                                          *
...
*>
 01  WS-Mysql-Vars.
     03  Ws-Mysql-Host-Name              pic x(64)   value spaces.
     03  Ws-Mysql-Implementation         pic x(64)   value spaces.
     03  Ws-Mysql-Password               pic x(64)   value spaces.
     03  Ws-Mysql-Base-Name              pic x(64)   value spaces.
     03  Ws-Mysql-Port-Number            pic x(4)    value spaces.
     03  Ws-Mysql-Socket                 pic x(64)   value spaces.
*>
