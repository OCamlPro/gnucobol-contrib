...
*>                 from dbpre) MUST be used and this is included in    *
*>                 the archive instead. Comments cleaned up.           *
*>                                      07/04/18.                      *
...
*>                This is now the only one supplied.                   *
*>                                                                     *
*>       This way bldcopy2 can be used for more than one MySQL server  *
*>       on more than one system within a LAN.                         *
*>        See the example file called bldcopy2.param                   *
...
*>                     27 February 2018.                               *
*>          2.08 - Version updated along with changed comments above.  *
